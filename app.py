...
class myweather:
    def __init__(self, root):
        ...
        lbl_city = Label(self.root, text = "City Name", font = ("Lato", 15),bg = "#033958", fg="Orange", anchor="w", padx="10").place(x = 0, y = 60, relwidth = 1, height = 40)
        txt_city = Entry(self.root, textvariable = self.var_search, font = ("Lato", 15),bg = "lightyellow", fg="blue").place(x = 115, y = 65, width = 250, height = 30)
        btn_search = Button(self.root, cursor = "hand2",bg="yellow", activebackground="#033958" ,bd=0, command = self.get_weather).place(x = 390, y = 65, width = 30, height = 30)

        # RESULTS #
        self.lbl_city = Label(self.root, font = ("Lato", 25, "bold"),bg = "white", fg="Orange")
        self.lbl_city.place(x = 0, y = 170, relwidth = 1, height = 50)
        ...
        self.lbl_temp = Label(self.root,font = ("Lato", 25),bg = "white", fg="Green")
        self.lbl_temp.place(x = 0, y = 230, relwidth = 1, height = 35)
        
        self.lbl_wind = Label(self.root,font = ("Lato", 15, "bold"),bg = "white", fg="Black")
        self.lbl_wind.place(x = 0, y = 300, relwidth = 1, height = 20)
        
        self.lbl_error = Label(self.root, font = ("Lato", 15, "bold"),bg = "white", fg="Red")
